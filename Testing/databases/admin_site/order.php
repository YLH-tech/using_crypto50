            ...
            <div class="trade-columns">
                <div class="buy-column">
                    ...
                    <form id="buy-form">
                        ...
                        <input type="number" id="buy-amount" placeholder="Amount"  min="0" step="0.000001" oninput="validateAmount('buy')">
                ...
                <div id="maxSellBTC">Max Sell BTC: 0.000000</div>
                    <form id="sell-form">
                        ...
                        <input type="number" id="sell-amount" placeholder="Amount"  min="0" step="0.000001" oninput="validateAmount('sell')">
                        <div>select period:</div>
                        <table class="option-table">
                            <tr>
                                <td><button type="button" class="time-option" onclick="selectTimeOption(this)">30s</button></td>
