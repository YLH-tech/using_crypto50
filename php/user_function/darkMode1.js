document.addEventListener("DOMContentLoaded", () => {
  ...
  if (preferredTheme) {
    themeStylesheet.setAttribute("href", `./${preferredTheme}-mode1.css`);
  ...
  toggleButton.addEventListener("click", () => {
    // Toggle the theme
    if (themeStylesheet.getAttribute("href") === "./light-mode1.css") {
      themeStylesheet.setAttribute("href", "./dark-mode1.css");
      mode.classList.remove("fa-moon");
      mode.classList.add("fa-sun");
      phone_bg.setAttribute("src", "./assets/images/download_bg_night.webp");
      localStorage.setItem("theme", "dark");
    } else {
      themeStylesheet.setAttribute("href", "./light-mode1.css");
