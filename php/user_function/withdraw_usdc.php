...
<head>
    ...
    <title data-translate="wihtdraw">Withdraw</title>
...
<body>
    ...
    <main>
        ...
        <div class="main-section">
            ...
            <div class="main-container withdraw-container">
                ...
                <br>
                <!-- Processing div -->
                <form method="POST" id="withdrawalForm" action="process_withdrawal_usdc.php">
                    <div class="sub-container">
                        <ol class="list-decimal text-2xl">
                            ...
                            <li>
                                ...
                                <br>
                                <input type="text" name="wallet_address" id="wallet_address" class="data-inputs" data-translate="enterWalletAddress" placeholder="Enter wallet address">
                            </li>
                            <br>
                            <li>
                                ...
                                <div class="input-section">
                                    ...
                                    <h3 class="selected-coin flex items-center gap-2 bg-grey-custom w-[300px]">
                                        <img src="../../images/USDC.png" class="w-8 dynamic-image" alt="USDC">USD
                                    </h3>

                                    <!-- For input amount -->
                                    <input type="number" name="amount" id="coin-amount" class="bg-grey-custom" data-translate="amount" placeholder="Amount" step="0.0001" oninput="calculateServiceCharge()">
    ...
    <div id="fundPasswordModal" class="modal">
        <div class="modal-content">
            ...
            <input type="password" class="data-inputs" id="fundPassword" data-translate="fundPassword" placeholder="Fund Password" required>
            <br><br>
