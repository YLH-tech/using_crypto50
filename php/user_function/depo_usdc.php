...
<body>
        ...
        <div class="main-section">
            ...
            <div class="main-container">
                ...
                <div class="qr-container">
                    <img src="../../images/USDC_QR.jpg" alt="USDC Coin QR" class="qr-img">
                    <p class="qr-explain" data-translate="qrExplanation_usdc">Please, Scan the QR for USDC Wallet Address</p>
                    <br>
                    <!-- Wallet Code -->
                ...
                <ol class="list-decimal text-2xl">
                    <!-- Processing div -->
                    <form action="../../admin/req_coin_usdc.php" method="post" enctype="multipart/form-data">
                            ...
                            <li>
                                ...
                                <div class="input-section">
                                    ...
                                    <h3 class="selected-coin flex items-center gap-2 bg-grey-custom w-[300px]">
                                        <img src="../../images/USDC.png" class="w-8" alt="USDC">USD
                                    </h3><br><br>
    ...
    <script>
        ...
        function code_copying() {
            ...
            alert("Copied the usdc code : " + copyText.value);
        }
    </script>
