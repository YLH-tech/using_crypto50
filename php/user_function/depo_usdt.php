...
if (isset($_POST['clear_history_user'])) {
    ...
    header("Location: depo_usdt.php"); // Refresh the page after clearing
    exit();
}
        ...
        <div class="main-section">
            ...
            <div class="main-container">
                ...
                <div class="qr-container">
                    <img src="../../images/Other_coins_QR.jpg" alt="USDT Coin QR" class="qr-img">
                    <p class="qr-explain">Please, Scan the QR for USDT Wallet Address</p>
                    <br>
                    <!-- Wallet Code -->
