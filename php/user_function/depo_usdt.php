...
<body>
        ...
        <div class="main-section">
            ...
            <div class="main-container">
                ...
                <div class="qr-container">
                    <img src="../../images/ETH_QR.jpg" alt="USDT Coin QR" class="qr-img">
                    <p class="qr-explain" data-translate="qrExplanation_usdt">Please, Scan the QR for USDT Wallet Address</p>
                    <br>
                    <!-- Wallet Code -->
                    <div class="m-auto w-fit">
                        <input type="text" value="0xbB926dF623dc8DbF583A952D7848B5Fa50DA9147" id="wallet-code"
                ...
                <ol class="list-decimal text-2xl">
                    <!-- Processing div -->
                    <form action="../../admin/req_coin_usdt.php" method="post" enctype="multipart/form-data">
                            ...
                            <li>
                                ...
                                <div class="input-section">
                                    ...
                                    <h3 class="selected-coin flex items-center gap-2 bg-grey-custom w-[300px]">
                                        <img src="../../images/USDT.png" class="w-8" alt="USDT">Tether
                                    </h3><br><br>
    ...
    <script>
        ...
        function code_copying() {
            ...
            alert("Copied the usdt code : " + copyText.value);
        }
    </script>
</body>
