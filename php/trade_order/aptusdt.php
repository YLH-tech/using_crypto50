...
<body>
            ...
            <div class="scrollable-area">
                <div class="trade-columns">
                    <div class="buy-column">
                        ...
                        <form id="buy-form">
                        <label for="buy-amount"><span data-translate="amount">Amount</span> (APT):</label>
                            ...
                            <button type="submit" id="buy-button"><span data-translate="buy">Buy</span> APT</button>
                        </form>
                    </div>
                    ...
                    <div class="sell-column">
                        ...
                        <form id="sell-form">
                            ...
                            <label for="sell-amount"><span data-translate="amount">Amount</span> (APT):</label>
                            ...
                            <button type="submit" id="sell-button"><span data-translate="sell">Sell</span> APT</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <table id="orderTable">
                <thead>
                    <tr>
                        ...
                        <th><span data-translate="amount">Amount</span> (APT)</th>
    ...
    async function fetchOrderHistory(page = 1) {
        try {
            const response = await fetch(`aptusdt.php?fetch_orders=1&page=${page}`);
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function connectWebSocket() {
                const ws = new WebSocket('wss://stream.binance.com:9443/ws/aptusdt@trade'); // Binance BTC/USDT trade stream
    ...
    <script>
        ...
        function showCountdownOverlay(formId, amount) {
            ...
            overlay.querySelector('.overlay-content').innerHTML = `
                ...
                <p>${translations["amount"] || "Amount"}: ${amount} APT</p>
        ...
        function showOrderConfirmation(symbol, amount, startPrice, orderDirection) {
            ...
            loadTranslation(selectedLanguage).then(data => {
                ...
                confirmationOverlay.querySelector('.overlay-content').innerHTML = `
                    ...
                    <p>${translations["amount"]}: ${amount} APT</p>
