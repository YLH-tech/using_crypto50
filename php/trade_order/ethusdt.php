            ...
            <div class="scrollable-area">
                <div class="trade-columns">
                    <div class="buy-column">
                        ...
                        <form id="buy-form">
                        <label for="buy-amount"><span data-translate="amount">Amount</span> (ETH):</label>
                            ...
                            <button type="submit" id="buy-button"><span data-translate="buy">Buy</span> ETH</button>
                        </form>
                    </div>
                    ...
                    <div class="sell-column">
                        ...
                        <label for="sell-amount"><span data-translate="amount">Amount</span> (ETH):</label>
                            ...
                            <button type="submit" id="sell-button"><span data-translate="sell">Sell</span> ETH</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <table id="orderTable">
                <thead>
                    <tr>
                        ...
                        <th><span data-translate="amount">Amount</span> (ETH)</th>
...
<script>
    ...
    async function fetchOrderHistory(page = 1) {
        try {
            const response = await fetch(`ethusdt.php?fetch_orders=1&page=${page}`);
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function connectWebSocket() {
                const ws = new WebSocket('wss://stream.binance.com:9443/ws/ethusdt@trade'); // Binance BTC/USDT trade stream
    ...
    <script>
        ...
        function showCountdownOverlay(formId, amount) {
            ...
            overlay.querySelector('.overlay-content').innerHTML = `
                ...
                <p>${translations["amount"] || "Amount"}: ${amount} ETH</p>
        ...
        function showOrderConfirmation(symbol, amount, startPrice, orderDirection) {
            ...
            loadTranslation(selectedLanguage).then(data => {
                ...
                confirmationOverlay.querySelector('.overlay-content').innerHTML = `
                    ...
                    <p>${translations["amount"]}: ${amount} ETH</p>
