document.addEventListener("DOMContentLoaded", () => {
  ...
  if (preferredTheme) {
    themeStylesheet.setAttribute("href", `./style/${preferredTheme}-mode.css`);
  ...
  toggleButton.addEventListener("click", () => {
    // Toggle the theme
    if (themeStylesheet.getAttribute("href") === "./style/light-mode.css") {
      themeStylesheet.setAttribute("href", "./style/dark-mode.css");
      mode.classList.remove("fa-moon");
      mode.classList.add("fa-sun");
      phone_bg.setAttribute("src", "./assets/images/download_bg_night.webp");
      localStorage.setItem("theme", "dark");
    } else {
      themeStylesheet.setAttribute("href", "./style/light-mode.css");
